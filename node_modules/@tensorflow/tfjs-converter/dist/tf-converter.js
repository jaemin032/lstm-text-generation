...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function loadTfHubModule(tfhubModuleUrl, requestOption, onProgress) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2, loadFrozenModel("" + tfhubModuleUrl + DEFAULT_MODEL_NAME + TFHUB_SEARCH_PARAM, "" + tfhubModuleUrl + DEFAULT_MANIFEST_NAME + TFHUB_SEARCH_PARAM, requestOption, onProgress)];
            });
        });
    }
    ...
    var OperationMapper$1 = (function () {
        ...
        OperationMapper.prototype.isControlFlow = function (node) {
            return CONTROL_FLOW_OPS$1.some(function (op) { return op === node.op; });
        };
        OperationMapper.prototype.isDynamicShape = function (node) {
    ...
    function loadFrozenModel$2(modelUrl, weightsManifestUrl, requestOption, onProgress) {
        tfc.deprecationWarn('tf.loadFrozenModel() is going away. ' +
