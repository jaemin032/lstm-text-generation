    ...
    ***************************************************************************** */
    ...
    var Identity = (function (_super) {
        ...
        function Identity(args) {
            var _this = _super.call(this) || this;
            _this.gain = args.gain != null ? tfc.scalar(args.gain) : getScalar(1.0);
            return _this;
        }
    ...
    var Layer = (function (_super) {
        ...
        function Layer(args) {
            ...
            _this.name = name;
            _this.trainable = args.trainable == null ? true : args.trainable;
        ...
        ModelTrainingYielder.prototype.maybeYieldOnBatch = function (logs) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(this.yieldEvery === 'auto')) return [3, 5];
                            this.batchCount++;
                            if (!(this.autoYieldEveryBatches == null)) return [3, 2];
                            t = tfc.util.now();
                        ...
                        case 2:
                            if (!(this.batchCount - this.lastYieldBatchCount >=
                                this.autoYieldEveryBatches)) return [3, 4];
                            return [4, tfc.nextFrame()];
                        case 3:
                            _a.sent();
                            this.lastYieldBatchCount = this.batchCount;
                        ...
                        case 4: return [3, 7];
                        case 5:
                            if (!(this.yieldEvery === 'batch')) return [3, 7];
                            return [4, tfc.nextFrame()];
                        case 6:
                            _a.sent();
                            _a.label = 7;
    ...
    function getTopologicalSortAndRecipientCounts(fetches, feedDict) {
        tfc.util.assert(fetches != null && fetches.length > 0, "Exepcted at least one fetch, got none");
        var finalSorted = [];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        callbacks = standardizeCallbacks(args.callbacks);
                        verbose = args.verbose == null ? 1 : args.verbose;
                        _a = configureCallbacks(callbacks, args.yieldEvery, verbose, args.epochs, null, null, getStepsPerEpoch(dataset, args), null, doValidation, callbackMetrics), callbackList = _a.callbackList, history_1 = _a.history;
    ...
    var Model = (function (_super) {
        ...
        Model.prototype.compile = function (args) {
            ...
            if (typeof args.optimizer === 'string') {
                this.optimizer = getOptimizer(args.optimizer);
            }
            else {
    ...
    function loadModelInternal(pathOrIOHandler, options) {
        return __awaiter(this, void 0, void 0, function () {
            var handlers;
            return __generator(this, function (_a) {
                if (options == null) {
                ...
                if (typeof pathOrIOHandler === 'string') {
                    ...
                    if (handlers.length === 0) {
                        handlers.push(tfc.io.browserHTTPRequest(pathOrIOHandler, null, null, null, options.onProgress));
                    }
                    else if (handlers.length > 1) {
                ...
                return [2, loadModelFromIOHandler(pathOrIOHandler, undefined, options)];
            });
        });
    }
    function loadModelFromIOHandler(handler, customObjects, options) {
        return __awaiter(this, void 0, void 0, function () {
            var artifacts, modelTopology, strict, fastWeightInit, model, skipMismatch, isNamedTensorMap;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (options == null) {
    ...
    function loadModel(pathOrIOHandler, strict) {
        if (strict === void 0) { strict = true; }
        tfc.deprecationWarn("tf.loadModel() is deprecated and will be removed in TensorFlow.js " +
            "1.0. Please switch to tf.loadLayersModel().");
        return loadModelInternal(pathOrIOHandler, { strict: strict });
    }
        ...
        BatchNormalization.prototype.call = function (inputs, kwargs) {
            ...
            return tfc.tidy(function () {
                ...
                var doMovingAverage = function (variable, value, momentum) {
                    tfc.tidy(function () {
                        var decay = getScalar(1.0).sub(getScalar(momentum));
    ...
    var Bidirectional = (function (_super) {
        ...
        function Bidirectional(args) {
            ...
            _this.forwardLayer =
                deserialize({ className: args.layer.getClassName(), config: layerConfig });
            ...
            _this.mergeMode = args.mergeMode;
            if (args.weights) {
